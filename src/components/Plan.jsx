  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        Experience the ultimate adventure and relaxation with our custom itineraries on your next trip.
        </p>
        <p className='pb-6'>
        Escape the hustle and bustle of daily life with a relaxing vacation to stunning destinations 
        worldwide. Wake up to the sound of waves crashing against the shore, feel the sun on your skin, 
        and breathe in fresh ocean air or retreat to a mountain paradise surrounded by lush greenery 
